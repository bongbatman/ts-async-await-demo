 ...
 * @param id
 */
var getStatusAlt = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var user, grades, avg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, users_1.getUser(id)];
            case 1:
                user = _a.sent();
                return [4 /*yield*/, grades_1.getGrades(user.schoolId)];
            case 2:
                grades = _a.sent();
                avg = 0;
                if (grades.length > 0) {
                ...
                return [2 /*return*/, user.name + " has a " + avg + "% in the class."];
        }
    });
}); };
